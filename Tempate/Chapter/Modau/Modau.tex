...
Nguồn phát tán thông tin sai lệch có thể được phát hiện thông qua khảo sát người dùng hoặc các phương pháp khai phá dữ liệu. Ngoài ra, tin đồn còn có thể được phát hiện thông qua việc sử dụng các đặc trưng như: thời gian, cấu trúc và ngữ nghĩa \cite{nguyen9}. Về phương diện mô hình hóa toán học, để phát hiện được nguồn phát tán thông tin sai lệch, Zhang và cộng sự đề xuất vấn đề Time Con-strained Misinformation Detection (TCMD) tìm kiếm tập đỉnh nhỏ nhất sao cho phát hiện được thông tin sai lệch lớn hơn ngưỡng t. Christakis \cite{chris} và cộng sự đề xuất một phương thực phát hiện sự lan truyền của “ổ dịch” bằng cách theo dõi người dùng sử dụng phương pháp lựa chọn ngẫu nhiên.
...
\begin {itemize}
	\item {\bfseries Mục tiêu nghiên cứu:} Đề tài thực hiện để đạt được các mục tiêu sau:
		\begin {enumerate} [+]
			...
			\item Thu thập dữ về người dùng trên mạng xã hội thực, đặc biệt là dữ liệu các đối tượng phát tán thông tin. Đưa ra kết quả thực nghiệm và đánh giá. 
		\end {enumerate}
...
\begin {itemize}
	...
	\item {\bfseries Phương pháp nghiên cứu thực tiễn}
		\begin {enumerate} [+]
			\item Phương pháp hỏi chuyền gia: Thu thập thông tin tài liệu, ý kiến của chuyên gia, đánh giá vấn đề, hỏi ý kiến từ các chuyên gia hàng đầu về lĩnh vực công nghệ thông tin và an toàn thông tin để có cái nhìn tổng quát hơn về vấn đề đang nghiên cứu.
