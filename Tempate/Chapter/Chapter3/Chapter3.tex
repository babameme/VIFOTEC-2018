...
\end{theo}
\begin{proof}
	Để chứng minh TMB là $\#P-hard$ chúng tôi sẽ chỉ ra độ khó của bài toán TMB là tương đương với độ khó của bài toán $s$-$t$ paths mà đã được chứng minh có độ khó là $\#P-hard$ trong \cite{vali}. 
