...
\end{proof}
Thuật toán tham lam có cách tiếp cận khá đơn giản là mỗi bước tìm đỉnh $u$ sao cho hàm $h(A)$ tăng nhiều nhất. Song vấn đề khó khăn nhất gặp phải là tính toán hàm $\sigma(\cdot)$ là $P-\text{khó})$, chứng minh trong \ref{}. Vì vậy chúng tôi đưa ra một thuật toán hiệu quả trong phần sau.
